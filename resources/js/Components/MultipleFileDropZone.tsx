...
const MultipleFileDropZone = React.forwardRef<HTMLInputElement, InputProps>(
(
    ...
    <div className='relative'>
        ...
        {imageUrl ? (
            ...
            <div className="text-gray-400">Click or Drag n' Drop Multiple Files</div>
