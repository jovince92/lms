...
const SignUpPage:FC<Props> = ({hrms_response}) => {
    ...
    return (
        <div className='h-full w-full flex flex-col items-center justify-center px-3'>
            <div className='mx-auto max-w-2xl flex flex-col space-y-3.5 p-3.5 border rounded-lg'>
                <div>
                ...
                <Separator />
                <form onSubmit={onSubmit} className='flex flex-col space-y-3.5'>
                    ...
                    <Button variant='ddc' type='submit' disabled={processing}>
                        {
                            processing && <Loader2 className='h-4 w-4 mr-2' />
                        }
                        Sign Up
                    </Button>
                </form>
